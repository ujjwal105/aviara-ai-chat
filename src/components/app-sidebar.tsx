...
// import * as React from "react";
// import { LifeBuoy, Send, Plus, MessageSquare } from "lucide-react"; // ADDED MessageSquare
...
// import { type Chat, getChats, setActiveChatId } from "../lib/chat-storage";
...
//   const loadChats = () => {
//     setChats(getChats());
//     setActiveChatIdState(localStorage.getItem("aviara-active-chat-id"));
//   };
...
//     return () => {
//       window.removeEventListener("chats-updated", handleChatUpdate);
...
//               className="font-medium py-6 bg-transparent "
//             >
