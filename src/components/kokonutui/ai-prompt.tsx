...
export default function AI_Prompt() {
  ...
  const [selectedModel, setSelectedModel] = useState("Gemini 2.5 Flash"); // UPDATED: Default to Gemini
  ...
  // ADDED: Handle submitting the prompt to the new API route
  const handleSubmit = async () => {
    ...
    try {
      ...
      // **IMPORTANT:** This is where you get the response.
      // For now, we'll log it. You'll want to pass this
      // to your parent component to display in a chat list.
      ...
      // You could show a generic error to the user
    } finally {
      setIsLoading(false);
    }
  };

  // UPDATED: handleKeyDown to call the new handleSubmit
  ...
  return (
    <div className="w-full py-4">
      <div className="bg-black/5 dark:bg-white/5 rounded-2xl p-1.5 pt-4">
        {/* ... (your existing "Build for free" banner) ... */}
        <div className="flex items-center gap-2 mb-2.5 mx-2">
          <div className="flex-1 flex items-center gap-2">
            <Gift className="h-3.5 w-3.5 dark:text-white text-black" />
          ...
          <div className="relative flex flex-col">
            <div className="overflow-y-auto" style={{ maxHeight: "400px" }}>
              <Textarea
                ...
                className={cn(
                  "w-full rounded-xl rounded-b-none px-4 py-3 bg-black/5 dark:bg-white/5 border-none text-black dark:text-white placeholder:text-black dark:placeholder:text-white/70 resize-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-lg",
                  "min-h-[72px]"
                )}
                ref={textareaRef}
                ...
                disabled={isLoading} // UPDATED: Disable when loading
              />
            </div>
            ...
            <div className="h-14 bg-black/5 dark:bg-white/5 rounded-b-xl flex items-center">
              <div className="absolute left-3 right-3 bottom-3 flex items-center justify-between w-[calc(100%-24px)]">
                <div className="flex items-center gap-2">
                  ...
                  <label
                    className={cn(
                      ...
                      isLoading && "opacity-50 cursor-not-allowed" // UPDATED
                    )}
                ...
                <button
                  ...
                  disabled={!value.trim() || isLoading} // UPDATED
                  onClick={handleSubmit} // UPDATED
                >
                  {isLoading ? ( // ADDED: Show spinner when loading
                    <Loader2 className="w-4 h-4 dark:text-white text-black animate-spin" />
                  ) : (
                    <ArrowRight
                      className={cn(
